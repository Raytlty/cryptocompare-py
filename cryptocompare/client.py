    ...
    def _parse_full_price(self, fsym, tsym, data) -> Dict[str, Any]:
        ...
        return {
            ...
            'info': {
                ...
                'last_market': data['LASTMARKET'],
                'volume_hour': data['VOLUMEHOUR'],
                'volume_hour_to': data['VOLUMEHOURTO'],
                'open_hour': data['OPENHOUR'],
                'high_hour': data['HIGHHOUR'],
                'low_hour': data['LOWHOUR'],
                'top_tier_volume_24hours': data['TOPTIERVOLUME24HOUR'],
                'top_tier_volume_24hours_to': data['TOPTIERVOLUME24HOURTO'],
                'change_24hours': data['CHANGE24HOUR'],
                'change_pct_24_hours': data['CHANGEPCT24HOUR'],
                'change_day': data['CHANGEDAY'],
                'change_pct_day': data['CHANGEPCTDAY'],
                'change_hour': data['CHANGEHOUR'],
                'change_pct_hour': data['CHANGEPCTHOUR'],
                'conversion_type': data['CONVERSIONTYPE'],
                'conversion_symbol': data['CONVERSIONSYMBOL'],
                'supply': data['SUPPLY'],
                'mk_tcap': data['MKTCAP'],
                'mk_tcap_penalty': data['MKTCAPPENALTY'],
                'total_volume_24hours': data['TOTALVOLUME24H'],
                'total_volume_24hours_to': data['TOTALVOLUME24HTO'],
                'total_top_tier_volume_24hours': data['TOTALTOPTIERVOLUME24H'],
                'total_top_tier_volume_24hours_to': data['TOTALTOPTIERVOLUME24HTO']
            }
        }
